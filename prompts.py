...
def langchain_qa(query):
    ...
    prompt_template = """
        ...
        You have access to all the application insights within the BlockWorks Online Azure DevOps project. Your goal is to assist users in retrieving the data they need by generating the appropriate Kusto queries based on their requests.
